...
{ 
	...
	{	printf("\n");
	    ...
	    printf("set_steering(x.x);  degrees (to the right)\n");
	    printf("set_throttle(x.x);   10.2 % (of max throttle).\n");
	    printf("set_braking(x.x);   braking).\n");
	    printf("set_speed(x.x);   speed (of max throttle).\n");
	    printf("set_off(x.x);   off.\n");
	    printf("\n");
	 ...
	 if(argc>2)
	 {
		if ((!strcmp(argv[1], "set"))&&(!strcmp(argv[2], "steering")))
		...
		if ((!strcmp(argv[1], "set"))&&(!strcmp(argv[2], "braking")))
		  { printf("\nCongratulations - set_braking(%s",(argv[3]));
			printf(")command recieved\n");	
			printf("\n");
			int brakevalue = atoi(argv[3]);
			set_braking(brakevalue);
			printf("\n");
		  }
	  
		if ((!strcmp(argv[1], "set"))&&(!strcmp(argv[2], "throttle")))
		  { printf("\nCongratulations - set_throttle(%s",(argv[3]));
			printf(")command recieved\n");	
			printf("\n");
			int throttlevalue = atoi(argv[3]);
			set_throttle(throttlevalue);
			printf("\n");
		  }
		  
	  	if ((!strcmp(argv[1], "set"))&&(!strcmp(argv[2], "speed")))
		  { printf("\nCongratulations - set_speed(%s",(argv[3]));
			printf(")command recieved\n");	
			printf("\n");
			int speedvalue = atoi(argv[3]);
			set_throttle(speedvalue);
			printf("\n");
		  }
		  
	  	if ((!strcmp(argv[1], "set"))&&(!strcmp(argv[2], "off")))
		  { printf("\nCongratulations - set_off(%s",(argv[3]));
			printf(")command recieved\n");	
			printf("\n");
			int offvalue = atoi(argv[3]);
			set_throttle(offvalue);
			printf("\n");
		  }	  
	 }
