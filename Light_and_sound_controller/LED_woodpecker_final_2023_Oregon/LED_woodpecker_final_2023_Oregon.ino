...
#define PIN1 47  // Front Right
#define PIN2 44 // Front Left
#define PIN3 46  // Right
#define PIN4 45 // Left
#define PIN5 48 // Rear Right
#define PIN6 49  // Rear Left
...
void setup() {
  ...
  ClearAllLeds();
//  demorun();   
 Initialization(0, 0, 250, 8, 1000, 0);
 ClearAllLeds ();
